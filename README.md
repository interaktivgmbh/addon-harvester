...
**Plone profile**: `Framework :: Plone` plus Volto/Aurora npm queries, with
Plone-specific enrichments (version compat, add-on categories, backend/frontend
pairing) that simply stay empty for other ecosystems.
